...
public class Level1Scenario : ScenarioScript
{
    ...
    protected override void Awake()
    {
        ...
        dictionaryNamesEnemiesWavesAndRewards = new() // по идее это надо будет вынести в Adjust-скрипт // редакци€ от 10.07.2025 - надо вынести это в редактор дл€ возможности настройки там
        {
    ...
    protected override void TimerFinished(string markerTimeWait)
    {
        ...
        switch (markerTimeWait)
        {
            ...
            case "waitTimeAfterFirstEnemyKill":
                MovingCameraPlayerToPoint(_cameraPlayer, transformPlayer, 16f); // перемещаем камеру к игроку (предварительно камеру игрока отцепл€ем от игрока в скрипте функции

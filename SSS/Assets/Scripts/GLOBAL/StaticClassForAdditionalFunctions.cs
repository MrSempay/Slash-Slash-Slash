...
public static class StaticClassForAdditionalFunctions : object
{
    ...
    // Получаем поля и свйоства заданного объекта obj на основе ПЕРЕДАННОГО СЛОВАРЯ С ИМЕНАМИ СВОЙСТВ/ПОЛЕЙ. Только те свойства и поля будут возвращены в результирующем словаря,
